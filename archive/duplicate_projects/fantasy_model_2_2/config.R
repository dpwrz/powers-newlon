...
# FANTASY MODEL 2.2 - WEEKLY ACCURACY ENGINE + 2.0 SEASON ENGINE
# ============================================================

PROJECT_VERSION <- "2.2"
MODEL_LINEAGE <- "Validated 2.0 season prior + 2.2 decomposed weekly opportunity/matchup/stacking engine"
