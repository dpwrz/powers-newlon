...
if (!all(file.exists(required_context))) stop("Compact PBP context store missing. Run source(\"BUILD_PBP_CONTEXT.R\") first.")
if (!all(file.exists(required_raw))) stop("Base player/team stats missing. Run source(\"01_download_data.R\") once.")
...
run_stage_20("Step 1/10: Building 2.0 opportunity/shrinkage feature store...", "02b_build_opportunity_data.R")
run_stage_20("Step 2/10: Re-running validated 1.2 direct walk-forward baseline...", "04_validate_models.R")
run_stage_20("Step 3/10: Validating 2.0 opportunity + shrinkage + residual architecture...", "04b_validate_2_0.R")
run_stage_20("Step 4/10: Training final 1.2 direct + fantasy decision models...", "03_train_models.R")
run_stage_20("Step 5/10: Training final 2.0 opportunity/residual models...", "03b_train_2_0_models.R")
run_stage_20("Step 6/10: Producing validated 1.2 direct 2026 projections...", "05_project_2026.R")
run_stage_20("Step 7/10: Producing 2.0 structured stat lines + final guardrail projections...", "05b_project_2_0.R")
run_stage_20("Step 8/10: Building dynasty projections...", "06_dynasty_projection.R")
run_stage_20("Step 9/10: Building league/scarcity rankings...", "07_rank_players.R")
run_stage_20("Step 10/10: Finding historical player comps...", "08_player_comps.R")

cat("\n========================================\n")
cat(" FANTASY MODEL 2.2 SEASON FOUNDATION COMPLETE\n")
cat("========================================\n\n")
