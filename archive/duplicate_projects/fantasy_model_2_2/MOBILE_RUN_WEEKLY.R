# ============================================================
# FANTASY MODEL 2.2 - POSIT-SAFE WEEKLY PIPELINE
# ============================================================
cat("\n========================================\n")
cat(" FANTASY MODEL 2.2 - WEEKLY RUN\n")
...
cat("Weekly philosophy: 2.0 prior + neutral role + opportunity/stat line + explicit matchup delta + direct challenger + chronological stack\n")
...
run_stage_22("Step 1/4: Building/refreshing resumable weekly PBP defense context...", "BUILD_WEEKLY_DEFENSE_CONTEXT.R")
run_stage_22("Step 2/4: Building strict pre-kickoff historical player-week features...", "09_build_weekly_data.R")
run_stage_22("Step 3/4: Walk-forward validating decomposed architecture + training 2.2 weekly models...", "10_train_validate_weekly.R")
run_stage_22(paste0("Step 4/4: Projecting every ", CURRENT_SEASON, " week + rest of season..."), "11_project_weekly_2026.R")

cat("\n========================================\n")
cat(" FANTASY MODEL 2.2 WEEKLY RUN COMPLETE\n")
cat("========================================\n\n")
cat("Validation:\n")
cat(" - output/weekly_model_quality_report.txt\n")
cat(" - output/weekly_validation_metrics.csv\n")
cat(" - output/weekly_2_2_validation_by_year.csv\n")
cat(" - output/weekly_2_2_matchup_calibration.csv
 - output/weekly_2_2_architecture_comparison.csv
 - output/weekly_2_2_cohort_metrics.csv
 - output/weekly_2_2_selected_stack.csv\n")
cat(" - output/weekly_2_2_feature_importance.csv\n\n")
cat("Production:\n")
