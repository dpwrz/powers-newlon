...
if (length(missing) > 0) {
  stop("Cannot resume from Step 3. Missing: ", paste(missing, collapse = ", "),
       ". Run source(\"runners/MOBILE_RUN_FAST.R\") again instead.")
}
...
run_stage_resume20("Step 3/10: Validating 2.0 opportunity + shrinkage + residual architecture...", "pipeline/04b_validate_2_0.R")
run_stage_resume20("Step 4/10: Training final 1.2 direct + fantasy decision models...", "pipeline/03_train_models.R")
run_stage_resume20("Step 5/10: Training final 2.0 opportunity/residual models...", "pipeline/03b_train_2_0_models.R")
run_stage_resume20("Step 6/10: Producing validated 1.2 direct 2026 projections...", "pipeline/05_project_2026.R")
run_stage_resume20("Step 7/10: Producing 2.0 structured stat lines + final guardrail projections...", "pipeline/05b_project_2_0.R")
run_stage_resume20("Step 8/10: Building dynasty projections...", "pipeline/06_dynasty_projection.R")
run_stage_resume20("Step 9/10: Building league/scarcity rankings...", "pipeline/07_rank_players.R")
run_stage_resume20("Step 10/10: Finding historical player comps...", "pipeline/08_player_comps.R")
